const terminalScripts = {
  ...
  plan: [
    ...
    {
      text: "  + 26 transitive packages · 27 of 27 analyzed · 26 platform binaries",
      kind: "dim",
      pause: 240,
    },
  ...
  doctor: [
    ...
    {
      text: "high      acme-json@2.1.0   prototype pollution  (fixed in 2.1.4)",
      kind: "bad",
      pause: 260,
    },
    {
      text: "critical  acme-http@1.0.0   request smuggling    (fixed in 1.0.1)",
      kind: "bad",
      pause: 300,
    },
    {
      text: "BLOCK  acme-http@1.0.1   install-script added, exfiltration, provenance downgrade",
      kind: "bad",
      pause: 340,
    },
    {
      text: "UNFIXABLE  acme-http: the official fix fails the supply-chain gate",
      kind: "bad",
      pause: 300,
    },
    {
      text: "verified   acme-json@2.1.4 · install ok · test ok · applied",
      kind: "good",
      pause: 260,
    },
  ...
  intent: [
    ...
    {
      text: 'prompt   "add rate limiting, keep the retry logic, log every rate-limited request"',
      kind: "dim",
      pause: 280,
    },
    { text: "3 claims extracted · 2 files changed", kind: "dim", pause: 240 },
    {
      text: "✓ delivered   add rate limiting               api-client.ts:1-39",
      kind: "good",
      pause: 240,
    },
    { text: "✓ preserved   retry logic untouched", kind: "good", pause: 240 },
    {
      text: "✗ dropped     log every rate-limited request  no matching change",
      kind: "bad",
      pause: 280,
    },
    { text: "! scope creep pagination.ts, 55 lines, never requested", kind: "bad", pause: 260 },
    {
      text: "! hallucinated axios.instance.throttle, not exported by axios",
      kind: "bad",
      pause: 320,
    },
  ...
  agent: [
    ...
    {
      text: 'codex exec "Read .warden/handoff.json and apply the fix"',
      kind: "command",
      typed: true,
      pause: 260,
    },
